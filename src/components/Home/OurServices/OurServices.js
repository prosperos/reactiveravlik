                                ...
                                <div className="col-lg-10">
                                    <div className="row move_block">
                                        ...
                                        {itemServices.map((item,idx) =>{
                                            const col_class = classNames({'col-lg-6': true, 'first': idx === 3 , 'second': idx === 1 ,'third offset-lg-6 ': idx === 2 , 'offset-lg-6 offset-sm-6 offset-md-6 offset-xl-6 offset-0': idx === itemServices.length-1 })
                                            return(
